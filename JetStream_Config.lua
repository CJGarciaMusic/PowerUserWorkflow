...
-- initializes any parameters not accounted for in config file
...
--
    ...
    dynamic_above_cushion.LuaString = config_settings.dynamic_above_cushion
    --
...
--
    local lyrics_all = config_settings.lyrics_all
--
...
--
    if dialog:ExecuteModal(nil) == finale.EXECMODAL_OK then
        ...
        config_settings.dynamic_above_cushion = dynamic_above_cushion.LuaString
        --
        ...
        if lyrics_all_check:GetCheck() == 1 then
            config_settings.lyrics_all = "true"
        else
            config_settings.lyrics_all = "false"
        end
        --
        config_save(config_settings)
    end

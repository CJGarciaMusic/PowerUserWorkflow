function harp_config_load()
    local path = path_set(harp_config_filename)
...
---
function harp()
    harp_config_filename = "com.harp_pedal_wizard.text"
...
--
                ...
                function harp_callback_ok(ctrl)
                    apply()
                end

                function harp_callback_update(ctrl)
                    scale_update()
                    pedals_update()
                end
...
--                            require('mobdebug').start()
                ...
                dialog:RegisterHandleCommand(harp_callback)
                dialog:RegisterHandleOkButtonPressed(harp_callback_ok)
                dialog:RegisterHandleDataListSelect(harp_callback_update)

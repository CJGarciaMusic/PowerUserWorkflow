...
editFilter("Edit", "Edit Filter…", {"Notes and Rests", "Markings", "Expressions: Tempo Marks, Tempo Alterations", "Text", "Text blocks (Assigned to Measures)", "Special Alterations", "Staff Styles"})